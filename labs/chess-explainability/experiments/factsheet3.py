...
a=ctx.analyze_and_show(AFT, focus="analysis", board_push=False)
print("keys:", list(a.keys()))
print("\n>>> a['analysis'] (assemble_analysis — the REAL NL briefing):")
print(json.dumps(a.get("analysis"), indent=2, default=str))
print("\n>>> a['facts']:", json.dumps(a.get("facts"), default=str))
print("\n>>> _brief(a) — what actually reaches ReadPrompt/PositionQuery:")
